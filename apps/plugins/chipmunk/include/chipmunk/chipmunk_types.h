#define CP_USE_DOUBLES 0
   ...
   #import "TargetConditionals.h"
	...
	#define cpfsqrt rb_sqrt
	#define cpfsin rb_sin
	#define cpfcos rb_cos
	#define cpfacos rb_acos
	#define cpfatan2 rb_atan2
	#define cpfmod rb_fmod
	#define cpfexp rb_exp
	#define cpfpow rb_pow
	#define cpffloor rb_floor
	#define cpfceil rb_ceil
#endif
